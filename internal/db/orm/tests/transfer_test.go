...
func createRandomTransfer(t *testing.T, account1, account2 orm.Account) orm.Transfer {
	arg := orm.CreateTransferParams{
...
func deleteTransferById(t *testing.T, id int64) {
	error := testQueries.DeleteTransfer(context.Background(), id)
	require.Nil(t, error)
}
...
func TestDeleteTransfer(t *testing.T) {
	...
	deleteTransferById(t, newTransfer.ID)
